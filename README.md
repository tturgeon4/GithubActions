[![Run App TannerTurgeon](https://github.com/tturgeon4/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/tturgeon4/GithubActions/actions/workflows/run-app.yaml)
